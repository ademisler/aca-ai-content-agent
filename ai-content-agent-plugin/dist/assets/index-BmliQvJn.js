...
#root .updated {
  ...
  const makeApiCall = /* @__PURE__ */ __name((_0, ..._1) => __async(null, [_0, ..._1], function* (path, options = {}) {
    if (!window.acaData) {
    ...
    const mergedOptions = __spreadProps(__spreadValues({}, options), { headers: __spreadValues(__spreadValues({}, defaultHeaders), options.headers) });
    const response = yield fetch(`${window.acaData.api_url}${path}`, __spreadValues({}, mergedOptions));
    if (!response.ok) {
  ...
  const settingsApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("settings"), "get"),
    save: /* @__PURE__ */ __name((settings) => makeApiCall("settings", {
      method: "POST",
      body: JSON.stringify(settings)
    }), "save"),
    update: /* @__PURE__ */ __name((settings) => makeApiCall("settings", {
      method: "POST",
      body: JSON.stringify(settings)
    }), "update")
  };
  const styleGuideApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("style-guide"), "get"),
    analyze: /* @__PURE__ */ __name(() => makeApiCall("style-guide/analyze", { method: "POST" }), "analyze"),
    save: /* @__PURE__ */ __name((styleGuide) => makeApiCall("style-guide", {
      method: "POST",
      body: JSON.stringify(styleGuide)
    }), "save"),
    update: /* @__PURE__ */ __name((styleGuide) => makeApiCall("style-guide", {
      method: "POST",
      body: JSON.stringify(styleGuide)
    }), "update")
  };
  const ideasApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("ideas"), "get"),
    generate: /* @__PURE__ */ __name((count = 5) => makeApiCall("ideas/generate", {
      method: "POST",
      body: JSON.stringify({ count })
    }), "generate"),
    generateSimilar: /* @__PURE__ */ __name((ideaId) => makeApiCall("ideas/similar", {
      method: "POST",
      body: JSON.stringify({ ideaId })
    }), "generateSimilar"),
    create: /* @__PURE__ */ __name((idea) => makeApiCall("ideas", {
      method: "POST",
      body: JSON.stringify(idea)
    }), "create"),
    update: /* @__PURE__ */ __name((id, updates) => makeApiCall(`ideas/${id}`, {
      method: "PUT",
      body: JSON.stringify(updates)
    }), "update"),
    delete: /* @__PURE__ */ __name((id) => makeApiCall(`ideas/${id}`, { method: "DELETE" }), "delete")
  };
  const draftsApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("drafts"), "get"),
    createFromIdea: /* @__PURE__ */ __name((ideaId) => makeApiCall("drafts/create", {
      method: "POST",
      body: JSON.stringify({ ideaId })
    }), "createFromIdea"),
    update: /* @__PURE__ */ __name((id, updates) => makeApiCall(`drafts/${id}`, {
      method: "PUT",
      body: JSON.stringify(updates)
    }), "update"),
    schedule: /* @__PURE__ */ __name((id, scheduledDate) => makeApiCall(`drafts/${id}/schedule`, {
      method: "POST",
      body: JSON.stringify({ scheduledDate })
    }), "schedule")
  };
  const publishedApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("published"), "get"),
    publish: /* @__PURE__ */ __name((draftId) => makeApiCall(`drafts/${draftId}/publish`, {
      method: "POST"
    }), "publish")
  };
  const activityApi = {
    get: /* @__PURE__ */ __name(() => makeApiCall("activity-logs"), "get"),
    create: /* @__PURE__ */ __name((log) => makeApiCall("activity-logs", {
      method: "POST",
  ...
  const _GoogleGenerativeAIError = class _GoogleGenerativeAIError extends Error {
    constructor(message) {
      super(`[GoogleGenerativeAI Error]: ${message}`);
    }
  };
  __name(_GoogleGenerativeAIError, "GoogleGenerativeAIError");
  let GoogleGenerativeAIError = _GoogleGenerativeAIError;
  const _GoogleGenerativeAIResponseError = class _GoogleGenerativeAIResponseError extends GoogleGenerativeAIError {
    constructor(message, response) {
      super(message);
      this.response = response;
    }
  };
  __name(_GoogleGenerativeAIResponseError, "GoogleGenerativeAIResponseError");
  let GoogleGenerativeAIResponseError = _GoogleGenerativeAIResponseError;
  const _GoogleGenerativeAIFetchError = class _GoogleGenerativeAIFetchError extends GoogleGenerativeAIError {
  ...
  __name(_GoogleGenerativeAIFetchError, "GoogleGenerativeAIFetchError");
  let GoogleGenerativeAIFetchError = _GoogleGenerativeAIFetchError;
  const _GoogleGenerativeAIRequestInputError = class _GoogleGenerativeAIRequestInputError extends GoogleGenerativeAIError {
  };
  __name(_GoogleGenerativeAIRequestInputError, "GoogleGenerativeAIRequestInputError");
  let GoogleGenerativeAIRequestInputError = _GoogleGenerativeAIRequestInputError;
  const _GoogleGenerativeAIAbortError = class _GoogleGenerativeAIAbortError extends GoogleGenerativeAIError {
  };
  __name(_GoogleGenerativeAIAbortError, "GoogleGenerativeAIAbortError");
  let GoogleGenerativeAIAbortError = _GoogleGenerativeAIAbortError;
  ...
  const _RequestUrl = class _RequestUrl {
  ...
  __name(_RequestUrl, "RequestUrl");
  let RequestUrl = _RequestUrl;
  ...
  const _ChatSession = class _ChatSession {
  ...
  const _GenerativeModel = class _GenerativeModel {
  ...
  __name(_GenerativeModel, "GenerativeModel");
  let GenerativeModel = _GenerativeModel;
  const _GoogleGenerativeAI = class _GoogleGenerativeAI {
    constructor(apiKey) {
      this.apiKey = apiKey;
    }
    /**
  ...
  __name(_GoogleGenerativeAI, "GoogleGenerativeAI");
  let GoogleGenerativeAI = _GoogleGenerativeAI;
  let genAI = null;
  const setGeminiApiKey = /* @__PURE__ */ __name((key) => {
    if (key && key.trim() !== "") {
      try {
  ...
  const Lightbulb = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const BookOpen = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Settings$1 = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const LayoutDashboard = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const FileText = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const AlertTriangle = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const CheckCircle = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const XCircle = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m15 9-6 6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m9 9 6 6" })
  ] }), "XCircle");
  const Clock = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "12,6 12,12 16,14" })
  ] }), "Clock");
  const Info = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 16v-4" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 8h.01" })
  ] }), "Info");
  const X = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M18 6 6 18" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m6 6 12 12" })
  ] }), "X");
  const Spinner = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: `${className} animate-spin`, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 12a9 9 0 1 1-6.219-8.56" }) }), "Spinner");
  const Send = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m22 2-7 20-4-9-9-4Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 2 11 13" })
  ] }), "Send");
  const Menu = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Google = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "currentColor", className, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,4.73 12.19,4.73C14.76,4.73 16.04,5.66 17.14,6.64L19.31,4.5C17.22,2.69 14.86,1.5 12.19,1.5C7.03,1.5 3,5.5 3,12C3,18.45 7.03,22.5 12.19,22.5C17.6,22.5 21.5,18.53 21.5,12.23C21.5,11.66 21.45,11.38 21.35,11.1Z" }) }), "Google");
  const Trash = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Pencil = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Edit = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m15 5 4 4" })
  ] }), "Edit");
  const Archive = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Calendar = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Sparkles = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m12 3-1.9 5.8-5.8 1.9 5.8 1.9 1.9 5.8 1.9-5.8 5.8-1.9-5.8-1.9zM5 21l1.9-5.8M17.1 17.1l5.8-1.9" }) }), "Sparkles");
  const ChevronLeft = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m15 18-6-6 6-6" }) }), "ChevronLeft");
  const ChevronRight = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m9 18 6-6-6-6" }) }), "ChevronRight");
  const PlusCircle = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", x2: "12", y1: "8", y2: "16" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "8", x2: "16", y1: "12", y2: "12" })
  ] }), "PlusCircle");
  const RefreshCw = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Eye = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "3" })
  ] }), "Eye");
  const Zap = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "13,2 3,14 12,14 11,22 21,10 12,10" }) }), "Zap");
  const Image = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const Shield = /* @__PURE__ */ __name(({ className, style }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className, style, children: [
  ...
  const NavItem = /* @__PURE__ */ __name(({ icon, label, view, currentView, onClick }) => {
  ...
  const Sidebar = /* @__PURE__ */ __name(({ currentView, setView, isOpen, closeSidebar }) => {
    const handleNavigation = /* @__PURE__ */ __name((view) => {
      setView(view);
      closeSidebar();
    }, "handleNavigation");
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `aca-sidebar ${isOpen ? "open" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "aca-sidebar-nav", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "dashboard",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("dashboard"), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "style-guide",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("style-guide"), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "ideas",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("ideas"), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "drafts",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("drafts"), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "calendar",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("calendar"), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavItem,
          {
            ...
            view: "published",
            currentView,
            onClick: /* @__PURE__ */ __name(() => handleNavigation("published"), "onClick")
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { paddingTop: "20px", borderTop: "1px solid #32373c", marginTop: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        NavItem,
        {
          ...
          view: "settings",
          currentView,
          onClick: /* @__PURE__ */ __name(() => handleNavigation("settings"), "onClick")
        }
      ) })
    ] });
  }, "Sidebar");
  ...
  const ActivityLogItem = /* @__PURE__ */ __name(({ log }) => {
  ...
  const ActivityLogList = /* @__PURE__ */ __name(({ logs }) => {
    if (logs.length === 0) {
  ...
  const PipelineItem = reactExports.memo(({ icon, title, count, description, view, onNavigate }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-stat-item", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: /* @__PURE__ */ __name(() => onNavigate(view), "onClick"),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-fade-in", children: [
      ...
      !isStyleGuideReady && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-alert info", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "15px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: /* @__PURE__ */ __name(() => onNavigate("style-guide"), "onClick"),
  ...
  const getClosestSliderValue = /* @__PURE__ */ __name((description) => {
  ...
  }, "getClosestSliderValue");
  const StyleGuideManager = /* @__PURE__ */ __name(({ styleGuide, onAnalyze, onSaveStyleGuide, isLoading }) => {
    ...
    const handleToneToggle = /* @__PURE__ */ __name((tone) => {
      ...
      if (editableGuide) {
        setEditableGuide(__spreadProps(__spreadValues({}, editableGuide), { tone: Array.from(newTones).join(", ") }));
      }
      markDirty();
    }, "handleToneToggle");
    const handleSliderChange = /* @__PURE__ */ __name((e) => {
      const value = parseInt(e.target.value, 10);
      setSentenceSliderValue(value);
      if (editableGuide) {
        const description = sentenceStructureMap[value] || sentenceStructureMap[50];
        setEditableGuide(__spreadProps(__spreadValues({}, editableGuide), { sentenceStructure: description }));
      }
      markDirty();
    }, "handleSliderChange");
    const handleFieldChange = /* @__PURE__ */ __name((field, value) => {
      if (editableGuide) {
        setEditableGuide(__spreadProps(__spreadValues({}, editableGuide), { [field]: value }));
        markDirty();
      }
    }, "handleFieldChange");
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-page-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "aca-page-title", children: "Style Guide" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aca-page-description", children: "Define your brand's unique voice and writing style. The AI analyzes your content to keep this guide current and relevant." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aca-card-title", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-stat-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-stat-info", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aca-stat-count", children: (styleGuide == null ? void 0 : styleGuide.lastAnalyzed) ? `Last updated: ${new Date(styleGuide.lastAnalyzed).toLocaleDateString()} at ${new Date(styleGuide.lastAnalyzed).toLocaleTimeString()}` : "Never analyzed" })
            ] })
          ] }),
        ...
        editableGuide ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-grid", style: { gap: "30px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-grid aca-grid-3", style: { padding: "20px", background: "#f6f7f7", borderRadius: "4px", border: "1px solid #ccd0d4" }, children: PREDEFINED_TONES.map((tone) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: /* @__PURE__ */ __name(() => handleToneToggle(tone), "onClick"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: /* @__PURE__ */ __name((e) => handleFieldChange("paragraphLength", e.target.value), "onChange"),
                  className: "aca-input",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: /* @__PURE__ */ __name((e) => handleFieldChange("formattingStyle", e.target.value), "onChange"),
                  className: "aca-input",
  ...
  const IdeaCard = /* @__PURE__ */ __name(({ idea, onCreateDraft, onArchive, onUpdateTitle, onGenerateSimilar, isLoading, isGeneratingSimilar }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", style: { margin: 0, minHeight: "140px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flexGrow: 1, marginBottom: "15px" }, children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "div",
        {
          onClick: /* @__PURE__ */ __name(() => setIsEditing(true), "onClick"),
          className: "aca-action-button",
          style: {
            padding: "8px 12px",
            margin: "-8px -12px",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-list-item", style: { padding: "15px 0 0 0", margin: 0 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              onClick: /* @__PURE__ */ __name(() => onGenerateSimilar(idea), "onClick"),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: /* @__PURE__ */ __name(() => onCreateDraft(idea), "onClick"),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: /* @__PURE__ */ __name(() => onArchive(idea.id), "onClick"),
              className: "aca-button secondary",
  ...
  const IdeaBoard = /* @__PURE__ */ __name(({ ideas, onGenerate, onCreateDraft, onArchive, onUpdateTitle, onGenerateSimilar, onAddIdea, isLoading, isLoadingDraft }) => {
    const [newIdeaTitle, setNewIdeaTitle] = reactExports.useState("");
    const handleAddIdeaSubmit = /* @__PURE__ */ __name((e) => {
      e.preventDefault();
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", style: { flexGrow: 1, marginBottom: 0 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ...
                type: "text",
                value: newIdeaTitle,
                onChange: /* @__PURE__ */ __name((e) => setNewIdeaTitle(e.target.value), "onChange"),
  ...
  const DraftCard = /* @__PURE__ */ __name(({ draft, onSelectDraft, onPublish, isPublishing }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-list-item", style: { padding: "15px 0 0 0", margin: 0, justifyContent: "flex-end", gap: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: /* @__PURE__ */ __name(() => {
              var _a;
              const editUrl = `${(_a = window.aca_object) == null ? void 0 : _a.admin_url}post.php?post=${draft.id}&action=edit`;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: /* @__PURE__ */ __name(() => onPublish(draft.id), "onClick"),
            disabled: isPublishing,
            className: "aca-button",
            style: {
  ...
  const DraftsList = /* @__PURE__ */ __name(({ drafts, onSelectDraft, onPublish, publishingId }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-fade-in", children: [
      ...
      drafts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "30px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: /* @__PURE__ */ __name(() => window.location.hash = "#ideas", "onClick"),
            className: "aca-button large",
            children: [
  ...
  const RadioCard = /* @__PURE__ */ __name(({ id, title, description, currentSelection, onChange }) => {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: "12px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              checked: isChecked,
              onChange: /* @__PURE__ */ __name(() => onChange(id), "onChange"),
              style: {
                marginTop: "2px",
                width: "18px",
                height: "18px",
  ...
  const IntegrationCard = /* @__PURE__ */ __name(({ title, icon, children, isConfigured }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", style: { margin: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "aca-card-title", children: [
        icon,
        title
      ] }),
  ...
  const Settings = /* @__PURE__ */ __name(({ settings, onSaveSettings }) => {
    ...
    reactExports.useEffect(() => {
      const loadGscAuthStatus = /* @__PURE__ */ __name(() => __async(null, null, function* () {
        try {
          const response = yield fetch(window.acaData.api_url + "gsc/auth-status", {
    ...
    const handleSettingChange = /* @__PURE__ */ __name((field, value) => {
      setCurrentSettings((prev) => __spreadProps(__spreadValues({}, prev), { [field]: value }));
    }, "handleSettingChange");
    const handleModeChange = /* @__PURE__ */ __name((mode) => {
      handleSettingChange("mode", mode);
      if (mode !== "full-automatic") {
        handleSettingChange("autoPublish", false);
      }
    }, "handleModeChange");
    const fetchSeoPlugins = /* @__PURE__ */ __name(() => __async(null, null, function* () {
      var _a;
      try {
        setSeoPluginsLoading(true);
        console.log("ACA: Fetching SEO plugins...");
        const response = yield fetch("/wp-json/aca/v1/seo-plugins", {
          headers: {
            "X-WP-Nonce": ((_a = window.acaData) == null ? void 0 : _a.nonce) || ""
          }
        });
    ...
    const handleAutoDetectSeo = /* @__PURE__ */ __name(() => {
      setIsDetectingSeo(true);
      fetchSeoPlugins().finally(() => {
        setIsDetectingSeo(false);
      });
    }, "handleAutoDetectSeo");
    const handleGSCConnect = /* @__PURE__ */ __name(() => __async(null, null, function* () {
      ...
      try {
        const response = yield fetch(window.acaData.api_url + "gsc/connect", {
          method: "POST",
          headers: { "X-WP-Nonce": window.acaData.nonce }
        });
        const data = yield response.json();
    ...
    const handleGSCDisconnect = /* @__PURE__ */ __name(() => __async(null, null, function* () {
      try {
        const response = yield fetch(window.acaData.api_url + "gsc/disconnect", {
          method: "POST",
          headers: {
            "X-WP-Nonce": window.acaData.nonce,
            "Content-Type": "application/json"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "full-automatic-radio", style: { display: "flex", alignItems: "flex-start", cursor: "pointer", gap: "12px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: /* @__PURE__ */ __name(() => handleModeChange("full-automatic"), "onChange"),
                  style: {
                    marginTop: "2px",
                    width: "18px",
                    height: "18px",
            ...
            currentSettings.mode === "full-automatic" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-form-group", style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: /* @__PURE__ */ __name((e) => handleSettingChange("autoPublish", e.target.checked), "onChange"),
                  style: {
                    marginTop: "2px",
                    width: "16px",
                    height: "16px",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    onChange: /* @__PURE__ */ __name((e) => handleSettingChange("geminiApiKey", e.target.value), "onChange"),
                    className: "aca-input"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: /* @__PURE__ */ __name((e) => handleSettingChange("imageSourceProvider", e.target.value), "onChange"),
                          style: { display: "none" }
                        }
                      ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        onChange: /* @__PURE__ */ __name((e) => handleSettingChange("aiImageStyle", e.target.value), "onChange"),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        ...
                        onChange: /* @__PURE__ */ __name((e) => handleSettingChange("googleCloudProjectId", e.target.value), "onChange"),
                        className: "aca-input"
                      }
                    ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        onChange: /* @__PURE__ */ __name((e) => handleSettingChange("googleCloudLocation", e.target.value), "onChange"),
                        className: "aca-select",
                        style: { maxWidth: "200px" },
                        children: [
                ...
                currentSettings.imageSourceProvider === "pexels" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group aca-fade-in", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: /* @__PURE__ */ __name((e) => handleSettingChange("pexelsApiKey", e.target.value), "onChange"),
                      className: "aca-input"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                currentSettings.imageSourceProvider === "unsplash" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group aca-fade-in", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: /* @__PURE__ */ __name((e) => handleSettingChange("unsplashApiKey", e.target.value), "onChange"),
                      className: "aca-input"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                currentSettings.imageSourceProvider === "pixabay" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-form-group aca-fade-in", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: /* @__PURE__ */ __name((e) => handleSettingChange("pixabayApiKey", e.target.value), "onChange"),
                      className: "aca-input"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              children: seoPluginsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px", padding: "20px 0" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gap: "12px" }, children: detectedSeoPlugins.map((plugin, index) => {
                    const getPluginIcon = /* @__PURE__ */ __name((pluginType) => {
                      switch (pluginType) {
                        case "rank_math":
                          return "🏆";
                        case "yoast":
                    ...
                    const getPluginColor = /* @__PURE__ */ __name((pluginType) => {
                      switch (pluginType) {
                        case "rank_math":
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: /* @__PURE__ */ __name((e) => handleSettingChange("gscClientId", e.target.value), "onChange"),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: /* @__PURE__ */ __name((e) => handleSettingChange("gscClientSecret", e.target.value), "onChange"),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-stat-item", style: { margin: 0 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-stat-info", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      (gscAuthStatus == null ? void 0 : gscAuthStatus.authenticated) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "aca-stat-count", style: { color: "#00a32a" }, children: [
                        "Connected as ",
                  ...
                  (gscAuthStatus == null ? void 0 : gscAuthStatus.authenticated) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
  ...
  const DraftModal = /* @__PURE__ */ __name(({ draft, onClose, onSave, settings }) => {
    ...
    const originalFocusKeywords = Array.from({ length: 5 }, (_, i) => {
      var _a;
      return ((_a = draft.focusKeywords) == null ? void 0 : _a[i]) || "";
    });
    ...
    reactExports.useEffect(() => {
      ...
      setEditedFocusKeywords(Array.from({ length: 5 }, (_, i) => {
        var _a;
        return ((_a = draft.focusKeywords) == null ? void 0 : _a[i]) || "";
      }));
      setSeoStatus("idle");
    ...
    const handleSendToSeoPlugin = /* @__PURE__ */ __name(() => {
    ...
    }, "handleSendToSeoPlugin");
    const handleKeywordChange = /* @__PURE__ */ __name((index, value) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex-shrink-0 p-4 border-b border-slate-700 flex justify-between items-center bg-slate-800/80 backdrop-blur-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
                value: editedTitle,
                onChange: /* @__PURE__ */ __name((e) => setEditedTitle(e.target.value), "onChange"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-prose mx-auto", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  id: "content-editor",
                  value: editedContent,
                  onChange: /* @__PURE__ */ __name((e) => setEditedContent(e.target.value), "onChange"),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: /* @__PURE__ */ __name((e) => setEditedMetaTitle(e.target.value), "onChange"),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                    {
                      ...
                      onChange: /* @__PURE__ */ __name((e) => setEditedMetaDescription(e.target.value), "onChange"),
                      rows: 3,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "focus-keywords", className: "space-y-2", children: editedFocusKeywords.map((keyword, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                      value: keyword,
                      onChange: /* @__PURE__ */ __name((e) => handleKeywordChange(index, e.target.value), "onChange"),
                      className: "w-full bg-slate-700 border border-slate-600 rounded-md p-2 text-sm text-slate-200 focus:ring-2 focus:ring-blue-500",
  ...
  const ToastIcon = /* @__PURE__ */ __name(({ type }) => {
    const iconProps = { style: { width: "20px", height: "20px", marginRight: "10px" } };
    switch (type) {
      case "success":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, __spreadValues({}, iconProps));
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(XCircle, __spreadValues({}, iconProps));
      case "warning":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AlertTriangle, __spreadValues({}, iconProps));
      case "info":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Info, __spreadValues({}, iconProps));
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Info, __spreadValues({}, iconProps));
    }
  }, "ToastIcon");
  const Toast = /* @__PURE__ */ __name(({ id, message, type, onDismiss }) => {
    reactExports.useEffect(() => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `aca-toast ${type}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: /* @__PURE__ */ __name(() => onDismiss(id), "onClick"),
          style: {
            background: "none",
            border: "none",
            color: "inherit",
          ...
          onMouseLeave: /* @__PURE__ */ __name((e) => e.currentTarget.style.opacity = "0.7", "onMouseLeave"),
  ...
  const PublishedPostCard = /* @__PURE__ */ __name(({ post, onSelectPost }) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", style: { margin: 0 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-list-item", style: { padding: "15px 0 0 0", margin: 0, justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: /* @__PURE__ */ __name(() => onSelectPost(post), "onClick"),
          className: "aca-button secondary",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "aca-nav-item-icon" }),
            "View Content"
  ...
  const PublishedList = /* @__PURE__ */ __name(({ posts, onSelectPost }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-fade-in", children: [
      ...
      posts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: /* @__PURE__ */ __name(() => window.location.hash = "#drafts", "onClick"),
            className: "aca-button large",
            children: [
  ...
  const ContentCalendar = /* @__PURE__ */ __name(({ drafts, publishedPosts, onScheduleDraft, onSelectPost }) => {
    ...
    const unscheduledDrafts = drafts.filter((draft) => !draft.scheduledFor);
    const scheduledDrafts = drafts.filter((draft) => draft.scheduledFor);
    const openWordPressEditor = /* @__PURE__ */ __name((postId) => {
      var _a;
      const adminUrl = ((_a = window.aca_object) == null ? void 0 : _a.admin_url) || "/wp-admin/";
      window.open(`${adminUrl}post.php?post=${postId}&action=edit`, "_blank");
    }, "openWordPressEditor");
    const getPostsForDate = /* @__PURE__ */ __name((date) => {
    ...
    const toggleDateExpansion = /* @__PURE__ */ __name((date) => {
      const dateStr = date.toISOString().split("T")[0];
    ...
    const handleDragStart = /* @__PURE__ */ __name((e, draft) => {
      e.dataTransfer.setData("text/plain", draft.id.toString());
      setDraggedDraft(draft);
    }, "handleDragStart");
    const handleDragOver = /* @__PURE__ */ __name((e, date) => {
      e.preventDefault();
      setDragOverDate(date);
    }, "handleDragOver");
    const handleDrop = /* @__PURE__ */ __name((e, date) => {
      e.preventDefault();
    ...
    const handleDragLeave = /* @__PURE__ */ __name((e) => {
      e.preventDefault();
    ...
    const nextMonth = /* @__PURE__ */ __name(() => setCurrentDate(new Date(currentDate.getFullYear(), currentDate.getMonth() + 1, 1)), "nextMonth");
    const prevMonth = /* @__PURE__ */ __name(() => setCurrentDate(new Date(currentDate.getFullYear(), currentDate.getMonth() - 1, 1)), "prevMonth");
    const renderPostItem = /* @__PURE__ */ __name((post, type, isCompact = false) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          onClick: /* @__PURE__ */ __name(() => openWordPressEditor(post.id), "onClick"),
          className: "aca-action-button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-card-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            daysInMonth.map((date, index) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  onDragOver: /* @__PURE__ */ __name((e) => handleDragOver(e, date), "onDragOver"),
                  onDrop: /* @__PURE__ */ __name((e) => handleDrop(e, date), "onDrop"),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-card-content", children: unscheduledDrafts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { textAlign: "center", color: "#666", margin: "20px 0" }, children: "No unscheduled drafts available" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))", gap: "12px" }, children: unscheduledDrafts.map((draft) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              draggable: true,
              onDragStart: /* @__PURE__ */ __name((e) => handleDragStart(e, draft), "onDragStart"),
              className: "aca-action-button",
              style: {
                background: "#f8f9fa",
              ...
              onMouseDown: /* @__PURE__ */ __name((e) => e.currentTarget.style.cursor = "grabbing", "onMouseDown"),
              onMouseUp: /* @__PURE__ */ __name((e) => e.currentTarget.style.cursor = "grab", "onMouseUp"),
  ...
  const App = /* @__PURE__ */ __name(() => {
    ...
    reactExports.useEffect(() => {
      const loadInitialData = /* @__PURE__ */ __name(() => __async(null, null, function* () {
        try {
          const [settingsData, styleGuideData, ideasData, draftsData, publishedData, activityData] = yield Promise.all([
            settingsApi.get(),
            styleGuideApi.get(),
            ideasApi.get(),
            draftsApi.get(),
    ...
    const addToast = reactExports.useCallback((toast) => {
      const id = Date.now();
      setToasts((prev) => [...prev, __spreadProps(__spreadValues({}, toast), { id })]);
    }, []);
    ...
    const handleAnalyzeStyle = reactExports.useCallback((showToast2 = true) => __async(null, null, function* () {
      setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { style: true }));
      try {
        const updatedStyleGuide = yield styleGuideApi.analyze();
        ...
        setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { style: false }));
      }
    }), [addToast, addLogEntry]);
    const handleSaveStyleGuide = reactExports.useCallback((updatedGuide) => __async(null, null, function* () {
      try {
        const savedGuide = yield styleGuideApi.update(updatedGuide);
    ...
    const handleGenerateIdeas = reactExports.useCallback((showToast2 = true, count = 5) => __async(null, null, function* () {
      if (!styleGuide) {
        addToast({ message: "Please create a style guide first", type: "warning" });
        return;
      }
      setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { ideas: true }));
      try {
        const newIdeas = yield ideasApi.generate(count);
        ...
        setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { ideas: false }));
      }
    }), [styleGuide, addToast, addLogEntry]);
    const handleGenerateSimilarIdeas = reactExports.useCallback((baseIdea) => __async(null, null, function* () {
      if (!styleGuide) {
        addToast({ message: "Please create a style guide first", type: "warning" });
        return;
      }
      setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { [`similar_${baseIdea.id}`]: true }));
      try {
        const similarIdeas = yield ideasApi.generateSimilar(baseIdea.id);
        ...
        setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { [`similar_${baseIdea.id}`]: false }));
      }
    }), [styleGuide, addToast, addLogEntry]);
    const handleCreateDraft = reactExports.useCallback((ideaId) => __async(null, null, function* () {
      if (!styleGuide) {
        addToast({ message: "Please create a style guide first", type: "warning" });
        return;
      }
      ...
      setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { [`draft_${ideaId}`]: true }));
      try {
        console.log("Calling draftsApi.createFromIdea with ideaId:", ideaId);
        const draft = yield draftsApi.createFromIdea(ideaId);
        console.log("Draft created successfully:", draft);
        setPosts((prev) => [draft, ...prev]);
        const updatedIdea = __spreadProps(__spreadValues({}, idea), { status: "archived" });
        yield ideasApi.update(ideaId, updatedIdea);
        ...
        setIsLoading((prev) => __spreadProps(__spreadValues({}, prev), { [`draft_${ideaId}`]: false }));
      }
    }), [ideas, styleGuide, addToast, addLogEntry]);
    const handleUpdateDraft = reactExports.useCallback((draftId, updates) => __async(null, null, function* () {
      try {
        const updatedDraft = yield draftsApi.update(draftId, updates);
    ...
    const handlePublishPost = reactExports.useCallback((draftId) => __async(null, null, function* () {
      setPublishingId(draftId);
      try {
        const publishedPost = yield publishedApi.publish(draftId);
    ...
    const handleScheduleDraft = reactExports.useCallback((draftId, scheduledDate) => __async(null, null, function* () {
      try {
        const updatedDraft = yield draftsApi.schedule(draftId, scheduledDate);
        setPosts((prev) => prev.map((p) => p.id === draftId ? updatedDraft : p));
    ...
    const handleArchiveIdea = reactExports.useCallback((ideaId) => __async(null, null, function* () {
      try {
        const idea = ideas.find((i) => i.id === ideaId);
        if (!idea) return;
        const updatedIdea = __spreadProps(__spreadValues({}, idea), { status: "archived" });
    ...
    const handleUpdateIdeaTitle = reactExports.useCallback((ideaId, newTitle) => __async(null, null, function* () {
      try {
        const idea = ideas.find((i) => i.id === ideaId);
        if (!idea) return;
        const updatedIdea = __spreadProps(__spreadValues({}, idea), { title: newTitle });
        yield ideasApi.update(ideaId, updatedIdea);
        setIdeas((prev) => prev.map((i) => i.id === ideaId ? updatedIdea : i));
    ...
    const handleSaveSettings = reactExports.useCallback((newSettings) => __async(null, null, function* () {
      try {
        yield settingsApi.update(newSettings);
    ...
    const handleAddIdea = reactExports.useCallback((title, description) => __async(null, null, function* () {
      try {
        const newIdea = {
          title: title.trim(),
        ...
        const createdIdea = yield ideasApi.create(newIdea);
    ...
    const renderView = /* @__PURE__ */ __name(() => {
      switch (view) {
        case "style-guide":
          return /* @__PURE__ */ jsxRuntimeExports.jsx(StyleGuideManager, { styleGuide, onAnalyze: /* @__PURE__ */ __name(() => handleAnalyzeStyle(false), "onAnalyze"), onSaveStyleGuide: handleSaveStyleGuide, isLoading: isLoading["style"] });
        case "ideas":
          return /* @__PURE__ */ jsxRuntimeExports.jsx(IdeaBoard, { ideas, onGenerate: /* @__PURE__ */ __name(() => handleGenerateIdeas(false, 5), "onGenerate"), onCreateDraft: /* @__PURE__ */ __name((idea) => handleCreateDraft(idea.id), "onCreateDraft"), onArchive: handleArchiveIdea, isLoading: isLoading["ideas"], isLoadingDraft: isLoading, onUpdateTitle: handleUpdateIdeaTitle, onGenerateSimilar: handleGenerateSimilarIdeas, onAddIdea: handleAddIdea });
        case "drafts":
        ...
        default:
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            Dashboard,
            {
              ...
              lastAnalyzed: styleGuide == null ? void 0 : styleGuide.lastAnalyzed,
              activityLogs,
              onNavigate: setView,
              onGenerateIdeas: /* @__PURE__ */ __name(() => handleGenerateIdeas(false, 5), "onGenerateIdeas"),
              onUpdateStyleGuide: /* @__PURE__ */ __name(() => handleAnalyzeStyle(false), "onUpdateStyleGuide"),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            onClick: /* @__PURE__ */ __name(() => setIsSidebarOpen(false), "onClick")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Sidebar,
          {
            ...
            closeSidebar: /* @__PURE__ */ __name(() => setIsSidebarOpen(false), "closeSidebar")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-main", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aca-mobile-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: /* @__PURE__ */ __name(() => setIsSidebarOpen(true), "onClick"),
      ...
      selectedDraft && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          draft: selectedDraft,
          onClose: /* @__PURE__ */ __name(() => setSelectedDraft(null), "onClose"),
          onSave: handleUpdateDraft,
          settings
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aca-toast-container", children: toasts.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(Toast, __spreadProps(__spreadValues({}, toast), { onDismiss: removeToast }), toast.id)) })
    ] });
  }, "App");
...
//# sourceMappingURL=index-BmliQvJn.js.map
