            ...
            <div className="bg-slate-800 p-6 rounded-lg border border-slate-700/80">
                ...
                <div className="space-y-6">
                     <IntegrationCard title="Google AI (Gemini)" isConfigured={!!currentSettings.geminiApiKey}>
                        <label htmlFor="gemini-api-key" className="text-sm font-medium text-slate-300">API Key</label>
                        <input id="gemini-api-key" type="password" placeholder="Enter Google AI API Key" value={currentSettings.geminiApiKey} onChange={e => handleSettingChange('geminiApiKey', e.target.value)} className="mt-1 w-full bg-slate-700 border border-slate-600 rounded-md p-2 text-sm focus:ring-2 focus:ring-blue-500"/>
                        <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-400 hover:underline mt-1.5 block">How to get a Google AI API key?</a>
                    </IntegrationCard>
