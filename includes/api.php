...
function aca_ai_content_agent_safe_decrypt( $data ) {
    ...
    $decrypted = aca_ai_content_agent_decrypt( $data );
 ...
 */
function aca_ai_content_agent_call_gemini_api( $prompt, $system_instruction = '', $api_args = [] ) {
    ...
    $api_key = ! empty( $api_key_encrypted ) ? aca_ai_content_agent_decrypt( $api_key_encrypted ) : '';
