...
class ACA_Admin {
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="?page=aca&tab=dashboard" class="nav-tab <?php echo $active_tab == 'dashboard' ? 'nav-tab-active' : ''; ?>"><?php _e('Dashboard', 'aca'); ?></a>
                <a href="?page=aca&tab=settings" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>"><?php _e('Settings', 'aca'); ?></a>
                <a href="?page=aca&tab=prompts" class="nav-tab <?php echo $active_tab == 'prompts' ? 'nav-tab-active' : ''; ?>"><?php _e('Prompt Editor', 'aca'); ?></a>
                <a href="?page=aca&tab=license" class="nav-tab <?php echo $active_tab == 'license' ? 'nav-tab-active' : ''; ?>"><?php _e('License', 'aca'); ?></a>
            </h2>
            ...
            if ($active_tab === 'dashboard') {
                ...
                <div class="aca-disclaimer">
                    <h3><?php _e('Legal Disclaimer', 'aca'); ?></h3>
                    <p><?php _e('All content generated by ACA is a "draft". It is essential that you review, edit, and verify all content before publishing. The final responsibility for the published content belongs to you.', 'aca'); ?></p>
                </div>
                <?php
    ...
    public function display_admin_notices() {
        if (empty(get_option('aca_gemini_api_key'))) {
            echo '<div class="notice notice-warning is-dismissible"><p>' . __('ACA: API key is not set. Please set it in the <a href="?page=aca&tab=settings">settings</a>.', 'aca') . '</p></div>';
        }
