...
class ACA_AI_Content_Agent_Admin {
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            if ($active_tab === 'dashboard') {
                ...
                <div class="aca-ai-content-agent-disclaimer">
    ...
    public function register_settings() {
        // Settings Group
        $group = 'aca_ai_content_agent_settings_group';

        // Register Settings
        register_setting($group, 'aca_ai_content_agent_gemini_api_key', ['sanitize_callback' => [$this, 'sanitize_and_obfuscate_api_key']]);
        register_setting($group, 'aca_ai_content_agent_options', ['sanitize_callback' => [$this, 'sanitize_options']]);

        // API Settings Section
        add_settings_section('aca_ai_content_agent_api_settings_section', esc_html__('API and Connection Settings', 'aca-ai-content-agent'), null, 'aca-ai-content-agent');
        add_settings_field('aca_ai_content_agent_gemini_api_key', esc_html__('Google Gemini API Key', 'aca-ai-content-agent'), [$this, 'render_api_key_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_api_test', esc_html__('Connection Test', 'aca-ai-content-agent'), [$this, 'render_api_test_button'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_copyscape_username', esc_html__('Copyscape Username', 'aca-ai-content-agent'), [$this, 'render_copyscape_username_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_copyscape_api_key', esc_html__('Copyscape API Key', 'aca-ai-content-agent'), [$this, 'render_copyscape_api_key_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_gsc_site_url', esc_html__('Search Console Site URL', 'aca-ai-content-agent'), [$this, 'render_gsc_site_url_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_gsc_api_key', esc_html__('Search Console API Key', 'aca-ai-content-agent'), [$this, 'render_gsc_api_key_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_pexels_api_key', esc_html__('Pexels API Key', 'aca-ai-content-agent'), [$this, 'render_pexels_api_key_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');
        add_settings_field('aca_ai_content_agent_openai_api_key', esc_html__('OpenAI API Key', 'aca-ai-content-agent'), [$this, 'render_openai_api_key_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_api_settings_section');

        // Automation Settings Section
        add_settings_section('aca_ai_content_agent_automation_settings_section', esc_html__('Automation Settings', 'aca-ai-content-agent'), null, 'aca-ai-content-agent');
        add_settings_field('aca_ai_content_agent_working_mode', esc_html__('Working Mode', 'aca-ai-content-agent'), [$this, 'render_working_mode_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_automation_settings_section');
        add_settings_field('aca_ai_content_agent_automation_frequency', esc_html__('Automation Frequency', 'aca-ai-content-agent'), [$this, 'render_automation_frequency_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_automation_settings_section');
        add_settings_field('aca_ai_content_agent_generation_limit', esc_html__('Generation Limit', 'aca-ai-content-agent'), [$this, 'render_generation_limit_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_automation_settings_section');
        add_settings_field('aca_ai_content_agent_default_author', esc_html__('Default Author', 'aca-ai-content-agent'), [$this, 'render_default_author_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_automation_settings_section');
        add_settings_field('aca_ai_content_agent_default_profile', esc_html__('Brand Voice Profile', 'aca-ai-content-agent'), [$this, 'render_default_profile_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_automation_settings_section');

        // Content Analysis Section
        add_settings_section('aca_ai_content_agent_analysis_settings_section', esc_html__('Content Analysis & Learning Rules', 'aca-ai-content-agent'), null, 'aca-ai-content-agent');
        add_settings_field('aca_ai_content_agent_analysis_post_types', esc_html__('Analyze Content Types', 'aca-ai-content-agent'), [$this, 'render_analysis_post_types_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_analysis_settings_section');
        add_settings_field('aca_ai_content_agent_analysis_depth', esc_html__('Analysis Depth', 'aca-ai-content-agent'), [$this, 'render_analysis_depth_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_analysis_settings_section');
        add_settings_field('aca_ai_content_agent_analysis_categories', esc_html__('Analysis Categories', 'aca-ai-content-agent'), [$this, 'render_analysis_categories_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_analysis_settings_section');
        add_settings_field('aca_ai_content_agent_style_guide_frequency', esc_html__('Style Guide Refresh', 'aca-ai-content-agent'), [$this, 'render_style_guide_frequency_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_analysis_settings_section');

        // Content Enrichment Section
        add_settings_section('aca_ai_content_agent_enrichment_settings_section', esc_html__('Content Enrichment', 'aca-ai-content-agent'), null, 'aca-ai-content-agent');
        add_settings_field('aca_ai_content_agent_internal_links_max', esc_html__('Max Internal Links', 'aca-ai-content-agent'), [$this, 'render_internal_links_max_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_enrichment_settings_section');
        add_settings_field('aca_ai_content_agent_featured_image_provider', esc_html__('Featured Image Provider', 'aca-ai-content-agent'), [$this, 'render_featured_image_provider_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_enrichment_settings_section');
        add_settings_field('aca_ai_content_agent_add_data_sections', esc_html__('Add Data Sections', 'aca-ai-content-agent'), [$this, 'render_add_data_sections_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_enrichment_settings_section');

        // Management and Cost Control Section
        add_settings_section('aca_ai_content_agent_management_settings_section', esc_html__('Management and Cost Control', 'aca-ai-content-agent'), null, 'aca-ai-content-agent');
        add_settings_field('aca_ai_content_agent_api_monthly_limit', esc_html__('Monthly API Limit', 'aca-ai-content-agent'), [$this, 'render_api_monthly_limit_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_management_settings_section');
        add_settings_field('aca_ai_content_agent_api_usage_display', esc_html__('Current API Usage', 'aca-ai-content-agent'), [$this, 'render_api_usage_display_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_management_settings_section');
        add_settings_field('aca_ai_content_agent_log_cleanup_enabled', esc_html__('Enable Log Cleanup', 'aca-ai-content-agent'), [$this, 'render_log_cleanup_enabled_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_management_settings_section');
        add_settings_field('aca_ai_content_agent_log_retention_days', esc_html__('Log Retention (days)', 'aca-ai-content-agent'), [$this, 'render_log_retention_days_field'], 'aca-ai-content-agent', 'aca_ai_content_agent_management_settings_section');
    ...
    public function render_prompts_page() {
        if ( isset( $_POST['submit'] ) ) {
            check_admin_referer( 'aca_ai_content_agent_prompts_group-options' );
        }
        ?>
        <form action="options.php" method="post">
            <?php
            ...
            <table class="widefat">
                ...
                <tbody>
                    ...
                    <?php endforeach; ?>
                    <tr><td><input type="text" name="aca_ai_content_agent_brand_profiles_new_key" placeholder="<?php esc_attr_e('new-profile', 'aca-ai-content-agent'); ?>"></td><td><textarea name="aca_ai_content_agent_brand_profiles_new_value" rows="4" class="large-text"></textarea></td></tr>
                </tbody>
            </table>
    ...
    public function sanitize_brand_profiles($input) {
        ...
        if ( ! empty( $_POST['aca_ai_content_agent_brand_profiles_new_key'] ) && ! empty( $_POST['aca_ai_content_agent_brand_profiles_new_value'] ) ) {
            check_admin_referer( 'aca_ai_content_agent_prompts_group-options' );
            $clean[ sanitize_key( wp_unslash( $_POST['aca_ai_content_agent_brand_profiles_new_key'] ) ) ] = sanitize_textarea_field( wp_unslash( $_POST['aca_ai_content_agent_brand_profiles_new_value'] ) );
        }
        return $clean;
    }
    ...
    public function render_license_page() {
        ...
        <form action="options.php" method="post">
            ...
            <input type="text" id="aca_ai_content_agent_license_key" name="aca_ai_content_agent_license_key" value="" placeholder="' . esc_attr( $placeholder ) . '" class="regular-text">
    ...
    public function add_plagiarism_metabox() {
        add_meta_box('aca_ai_content_agent_plagiarism', esc_html__('Plagiarism Check', 'aca-ai-content-agent'), [$this, 'render_plagiarism_metabox'], 'post', 'side');
    }
    ...
    public function render_plagiarism_metabox($post) {
        $raw = get_post_meta($post->ID, '_aca_ai_content_agent_plagiarism_raw', true);
        if (empty($raw)) {
