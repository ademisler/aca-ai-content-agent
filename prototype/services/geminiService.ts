...
// Ensure the API key is available. In a real environment, this would be set.
if (!process.env.API_KEY) {
  // In a real scenario, you'd have a robust error handling or fallback.
  // For this example, we'll log a warning and proceed,
  // expecting the user's environment to have the key.
  console.warn(
    "API_KEY environment variable not set. The application will not function without it."
  );
}
